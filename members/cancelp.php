...
$u = $row[0];
		...
		if (mysql_num_rows($result) >= 1) {
			...
			mysql_query("DELETE FROM pescrow WHERE location = '$l' LIMIT 1;");
			echo "<div id='crimestext' align='center'>The escrow was canceled!<br><a href='porto.php'>Go Back</a></div>";
			include("footer.php");
			...
			echo "<div id='crimestext' align='center'>There is not an escrow open!<br><a href='porto.php'>Go Back</a></div>";
			include("footer.php");
			exit();
			}
		} else {
		echo "<div id='crimestext' align='center'>You do not own an Airport!<br><a href='porto.php'>Go Back</a></div>";
		include("footer.php");
		exit();
		}
?>