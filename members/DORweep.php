...
echo '<div id="crimestext" align="center">You need to be the Weapons Expert in an Organized Robbery first!<br /><a href="DOR.php">Go back.</a></div>';
include("footer.php");
exit();
} else {
if ($_REQUEST['update']) {
	...
	$newlwep = $amlweap - 1;
	if ($newlwep < 0) {
		echo '<div id="crimestext" align="center">You need to own the weapons before using them!<br /><a href="DOR.php">Go back.</a></div>';
		include("footer.php");
		exit();
	}
...
echo '<div id="crimestext" align="center">Please go back and select weapons to use in the Organized Robbery!<br /><a href="DOR.php">Go back.</a></div>';
include("footer.php");
exit();
}
}
