...
?>
<br /><br />
<form action="csellg.php" method="post"><div align="center" id="garage">
<h1 align="center"><? echo("$cname"); ?> Garage</h1>
<table>
  <tr class="top">
    <td><b>Vehicle</b></td>
...
<?	 
$query=mysql_query("SELECT * FROM cgarage WHERE corp='$corp' ORDER BY car ASC"); 
...
<table width="50%" align="center">
	<tr><td align="center" colspan="2"><b>Your Garage</b><br /></td></tr>
	</div>
  	<form action="cdonatecar.php" method="POST">
		<div align="center">
		...
		$query=mysql_query("SELECT id, car, percent FROM garage WHERE username='$u'"); 
		while ($row=mysql_fetch_array($query)){
		$ucar=$row['car'];
		$ucaid = $row['id'];
...
<h1 align="center"><? echo("$corp"); ?> Garage</h1>
<table>
  <tr class="top">
    <td><b>Vehicle</b></td>
    <td width="11%"><b>Percent</b></td>
...
echo ("There has been an error. Message an Admin immediately. (Code= cgarage vs status)");
}
}
?>