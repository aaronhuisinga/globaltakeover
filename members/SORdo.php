...
if ($_REQUEST['Commit']) {
	...
	if ($u != $lead) {
		...
		if ($lead != 'None' AND $driver != 'None' AND $ee != 'None' AND $wep != 'None' AND $rcar != NULL AND $explosive != NULL AND $lgun != NULL AND $dgun != NULL AND $egun != NULL AND $wgun != NULL AND $hack != NULL) {
			...
			if ($rcar == 'Nuclear Submarine') {
			$carn = 9;
			} elseif ($rcar == 'Cruiser'){
			$carn = 8;
			} elseif ($rcar == 'Destroyer') {
			$carn = 7;
			} elseif ($rcar == 'Army submarine') {
			$carn = 6;
			} elseif ($rcar == 'Battleship') {
			$carn = 5;
			} elseif ($rcar == 'Submarine') {
			$carn = 4;
			} elseif ($rcar == 'Catermaran') {
			$carn = 3;
			} elseif ($rcar == 'Air Craft Carrier') {
			$carn = 2;
			} elseif ($rcar == 'Dingy') {
			$carn = 1;
			}
			...
			$exn = 4;
			} elseif ($explosive == 'Claymore Mines') {
			$exn = 3;
			} elseif ($explosive == 'Plastic Explosives') {
			$exn = 2;
			...
			$mn = $wpn + $exn + $carn + $exh;
			if ($mn > 73) {
			$ormon = rand (9000000, 10000000);
			} elseif ($mn > 63) {
			$ormon = rand (6000000, 8000000);
			} elseif ($mn > 49 AND $mn < 64) {
			$ormon = rand (5500000, 6500000);
			} elseif ($mn > 39 AND $mn < 50) {
			$ormon = rand (5000000, 5500000);
