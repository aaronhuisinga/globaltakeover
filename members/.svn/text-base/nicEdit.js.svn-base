...
var nicEditorConfig = bkClass.extend({
	buttons : {
		...
		'strikethrough' : {name : __('Click to Strike Through'), command : 'strikeThrough', tags : ['S'], css : {'text-decoration' : 'line-through'}, key : 's'},
...
var nicEditorInstance = bkClass.extend({
	...
	construct : function(e,options,nicEditor) {
		...
		if(isTextarea || this.options.hasPanel) {
			...
			var s = {width: newX+'px', border : '1px solid #ccc', borderTop : 0, overflowY : 'auto', overflowX: 'hidden', backgroundColor : '#FFFFFF', color : '#000' };
...
var nicBBCode = bkClass.extend({
	...
	toBBCode : function(xhtml) {
		...
		rp(/<span.*?style="text-decoration:line-through;">(.*?)<\/span>/gi,"[s]$1[/s]");
	...
	fromBBCode : function(bbCode) {
		...
		rp(/\[s\](.*?)\[\/s\]/gi,"<span style=\"text-decoration:line-through;\">$1</span>");
