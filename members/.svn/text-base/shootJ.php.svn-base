...
exit();
	...
	echo "<div id=\"crimestext\" align=\"center\">Thank you, $user! We will now attempt to get information out of Jonah, please come back to HQ to see if we need anymore help!</div>";
	exit();
	}
	}
	}
