...
exit();
	...
	$sql = mysql_query("SELECT `Oonelth` FROM `mission10` WHERE username = '$user'");
	...
	<a href=\"shootOr.php?id={$id}\">Go back.</a></center></div>");
	exit();
	...
	*/
	...
	mysql_query("UPDATE mission10 SET bulletused = '$new_bullet' WHERE username = '$user'");
	...
	<a href=\"missions.php\">Go back to Missions</a></center></div>";
	...
	mysql_query("DELETE FROM mspies WHERE target='$target' and hunter='$user'");
	mysql_query("UPDATE mission10 SET bulletused = '$new_bullet' WHERE username = '$user'");
	$sql = mysql_query("UPDATE mission10 SET missionstats = '1' WHERE username = '$user'");
	...
	echo("<div id=\"gameplay\"><center><form name='shoot' action='shootOr.php?id={$id}' method='POST'>
	<table id=\"usertable\">
