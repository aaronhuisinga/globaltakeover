...
exit();
	...
	<a href=\"shootC.php?id={$id}\">Go back.</a></center></div>");
	exit();
	...
	*/
	...
	$sql = mysql_query("UPDATE mission3 SET missionstats = '5' WHERE username = '$user'");
	// Drop Props
	$current = time();
	...
	<form action=\"mission3.php\" method= \"POST\"><input type=\"submit\" name=\"Finish\" value=\"Finish Mission!\"></form></center></div>";
	...
	mysql_query("DELETE FROM mspies WHERE target='$target' and hunter='$user'");
	$sql = mysql_query("UPDATE mission3 SET missionstats = '3' WHERE username = '$user'");
	echo "<div id=\"gameplay\"><center>You ambushed $target, but she was ready for you and fled!<br />
	You got a few shots off, and the target lost $damage health.<br />
	...
	echo("<div id=\"gameplay\"><center><form name='shoot' action='shootC.php?id={$id}' method='POST'>
	<table id=\"usertable\">
