...
exit();
	...
	$sql = mysql_query("SELECT `Jonah`, bulletused FROM `mission4` WHERE username = '$user'");
	...
	<a href=\"shootJr.php?id={$id}\">Go back.</a></center></div>");
	exit();
	...
	*/
	...
	mysql_query("UPDATE mission4 SET bulletused = '$new_bullet' WHERE username = '$user'");
	$sql = mysql_query("UPDATE mission4 SET missionstats = '3' WHERE username = '$user'");
	// Drop Props
	...
	<form action=\"mission4.php\" method= \"POST\"><input type=\"submit\" name=\"Finish\" value=\"Finish Mission!\"></form></center></div>";
	...
	mysql_query("DELETE FROM mspies WHERE target='$target' and hunter='$user'");
	mysql_query("UPDATE mission4 SET bulletused = '$new_bullet' WHERE username = '$user'");
	$sql = mysql_query("UPDATE mission4 SET missionstats = '1' WHERE username = '$user'");
	...
	echo("<div id=\"gameplay\"><center><form name='shoot' action='shootJr.php?id={$id}' method='POST'>
	<table id=\"usertable\">
