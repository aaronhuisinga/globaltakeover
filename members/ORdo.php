...
if ($_REQUEST['Commit']) {
	...
	if ($u != $lead) {
		...
		if ($lead != 'None' AND $driver != 'None' AND $ee != 'None' AND $wep != 'None' AND $rcar != NULL AND $explosive != NULL AND $lgun != NULL AND $dgun != NULL AND $egun != NULL AND $wgun != NULL AND $hack != NULL) {
			...
			if ($rcar == 'Tank') {
			$carn = 9;
			} elseif ($rcar == 'Barracks OL'){
			$carn = 8;
			} elseif ($rcar == 'Patrol Car') {
			$carn = 7;
			} elseif ($rcar == 'Hummer H3') {
			$carn = 6;
			} elseif ($rcar == 'APV') {
			$carn = 5;
			} elseif ($rcar == 'Lorry') {
			$carn = 4;
			} elseif ($rcar == 'Range Rover') {
			$carn = 3;
			} elseif ($rcar == 'Buggy') {
			$carn = 2;
			} elseif ($rcar == 'Jeep') {
			...
			if ($explosive == 'RH-202 Anti-Aircraft Gun') {
			$exn = 5;
			} elseif ($explosive == 'MLRS M270 12x227mm Multiple Rocket Launcher') {
			$exn = 4;
			} elseif ($explosive == 'M53/59 Self-Propelled Twin 30mm Cannon') {
			$exn = 3;
			} elseif ($explosive == 'PLZ-45 Self-Propelled 155mm Howitzer') {
			$exn = 2;
			...
			$mn = $wpn + $exn + $carn + $exh;
			if ($mn >= 73) {
			$ormon = rand (9500000, 10000000);
			} elseif ($mn > 63 AND $mn < 73) {
			$ormon = rand (8000000, 9500000);
			} elseif ($mn > 49 AND $mn < 64) {
			$ormon = rand (7000000, 8500000);
			} elseif ($mn > 39 AND $mn < 50) {
			$ormon = rand (7000000, 7500000);
			} elseif ($mn > 29 AND $mn < 40) {	
			$ormon = rand (4000000, 6500000);
